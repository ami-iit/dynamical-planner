...
levi::Expression DynamicalPlanner::Private::RotationExpression(const levi::Expression &normalizedQuaternion)
{
...
levi::Expression DynamicalPlanner::Private::G_Expression(const levi::Expression &normalizedQuaternion)
{
