 ...
 *
 */
#ifndef DPLANNER_CLASSICALPLANARCOMPLEMENTARITYCONSTRAINT_H
#define DPLANNER_CLASSICALPLANARCOMPLEMENTARITYCONSTRAINT_H
...
namespace DynamicalPlanner {
    namespace Private {
        class ClassicalPlanarComplementarityConstraint;
    }
}

class DynamicalPlanner::Private::ClassicalPlanarComplementarityConstraint : public iDynTree::optimalcontrol::Constraint {
...
public:
    ...
    ClassicalPlanarComplementarityConstraint(const VariablesLabeller& stateVariables, const VariablesLabeller& controlVariables,
                                             const std::string &footName, size_t contactIndex, double tolerance);

    ~ClassicalPlanarComplementarityConstraint() override;
    ...
    virtual bool constraintJacobianWRTControl(double, const iDynTree::VectorDynSize&state, const iDynTree::VectorDynSize&control,
                                              iDynTree::MatrixDynSize& jacobian) override;
...
#endif // DPLANNER_CLASSICALPLANARCOMPLEMENTARITYCONSTRAINT_H
